...
mkImage :: URL -> Fay Image
mkImage = ffi "window['mkImage'](%1)"
...
drawImage :: Context -> Image -> Double -> Double -> Double -> Double -> Fay ()
drawImage = ffi "%1['drawImage'](%2, %3, %4, %5, %6)"
